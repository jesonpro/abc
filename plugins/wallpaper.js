...
if (Config.WORKTYPE == 'private') {
    ...
    Neutro.tenu({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid, Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'Made by Neutro'})

    }));
}
else if (Config.WORKTYPE == 'public') {

    Neutro.tenu({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    Neutro.tenu({pattern: 'wallpaper', fromMe: true, desc: Lang.WP, dontAddCommandList: true}, (async (message, match) => {
