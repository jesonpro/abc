...
if (Config.WORKTYPE == 'private') {
    ...
    Neutro.tenu({pattern: 'neko', fromMe: true, desc: Lang.NEKO_DESC}, (async (message, match) => {
    ...
    Neutro.tenu({pattern: 'neko', fromMe: false, desc: Lang.NEKO_DESC}, (async (message, match) => {
    ...
    Neutro.tenu({pattern: 'neko', fromMe: true, desc: Lang.NEKO_DESC, dontAddCommandList: true}, (async (message, match) => {
