...
async function whatsAsena () {
    ...
    conn.on ('open', async () => {
        console.log(
            chalk.blueBright.italic('✅Loging information Updated!')
        );
...
${chalk.blue.italic('🙇Connecting Whatsapp..')}`);
    });
    conn.on('credentials-updated', async () => {
        ...
        console.log(
            chalk.blueBright.italic('⬇️pluggings Updating...')
        );
        if (os.userInfo().homedir !== clh.pay) return;
        // ==================== External Plugins ====================
        ...
        console.log(
            chalk.blueBright.italic('⬇️pluggings Updated...')
        );
        ...
        let EVA_ACTİON = config.LANG == 'SI' || config.LANG == 'AZ' ? '*🎭Neotro-X ChatBot ලෙස ක්‍රියා කරයි!* 🙇\n\n_නැවත සාමාන්‍ය ලෙස ක්‍රියාකිරීමට_ *.fulleva off* _මෙම විධානය භාවිත කරන්න._\n\n*🎭Neotro-X භාවිත කිරීම සම්බන්ධයෙන් ස්තූතියි. 💌*\n    *- Eva*' : '*🎭Neotro-X Working as a Chatbot! 🙇*\n\n_The purpose of this mod is to turn the bot into a fully functional AI chatbot._\n_You can use the_ *.eva off* _command to return to normal mode._\n\n*Thanks For Using 🎭Neotro-X 💌*\n    *- Eva*'
        ...
        if (config.WORKTYPE == 'public') {
            ...
            if (config.LANG == 'SI' || config.LANG == 'AZ') {
                ...
                if (commits.total === 0) {
                    ...
                    await conn.sendMessage(
                        conn.user.jid,
                        '```යතාවත් කාලීන කිරීමට``` *.update now* ```යොදන්න.```\n\n' + degisiklikler + '```', MessageType.text
                    ); 
                }
            }
            else { 
                            ...
                            if (config.LANG == 'SI' || config.LANG == 'AZ') {
                                ...
                                if (error.message.includes('URL')) {
                                    ...
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ 🙇දෝශ විශ්ලේෂණය [🎭Neotro-X] ⚕️*' + 
                                        ...
                                        '\n*🎭හේතුව:* _ප්ලගීනයේ කේත වැරදියි_' +
                                        '\n*🧚‍♂️විසඳුම:* _ප්ලගීනය පරීක්ෂා කරන්න._'
                                        , MessageType.text
                                    );
                                }
                                    ...
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ 🙇දෝශ විශ්ලේෂණය [🎭Neotro-X] ⚕️*' + 
                                        '\n========== ```🙇දෝශ විශ්ලේෂණය!``` ==========' +
                                        '\n\n*🚫ප්‍රධාන දෝෂය:* _Reply Delete Function_' +
                                        '\n*🎭හේතුව:* _IMG හෝ Wiki විධානයන් භාවිතා කිරීම. (Official වට්ස්ඇප් භාවිතය.)_._' +
